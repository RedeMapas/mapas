            ...
            <div class="login__card__content">
                <form class="login__form" @submit.prevent="doLogin();">
                    ...
                    <div class="login__buttons">
                        <button class=" button button--primary button--large button--bg" type="submit"> <?= i::__('Entrar') ?> </button>
                    ...
                    <div class="create ">
                        ...
                        <a class=" button button--primary button--large button--bg" href="<?php echo $app->createUrl('auth', 'register') ?>"> 
